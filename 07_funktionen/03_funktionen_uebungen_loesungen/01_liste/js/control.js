...
let allesLoeschen = document.querySelector("#allesLoeschen");
let letztesLoeschen = document.querySelector("#letztesLoeschen");
...
letztesLoeschen.addEventListener("click", function(){
